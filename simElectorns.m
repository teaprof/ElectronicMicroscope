function traj = simElectorns(r0, v0, EMfieldSolution, tspan, electronsPerParticle)
    x0 = PhaseToX(r0, v0);
    N = size(r0, 2);    
...
%3. No interaction
%     sol = ode45(@(t, x) rightSideNoInteraction(t, x, N, EMfieldSolution, electronsPerParticle), tspan, x0);
    
    traj.t = sol.x;
    traj.rv = sol.y;
    traj.Nparticles = N;
    [X, Y, Z] = solToPhase(sol);
